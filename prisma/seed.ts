...
// ============================================
// Sample Parties with realistic legal case data
// ============================================
...
const RISK_PROFILES: RiskProfileSeed[] = [
  {
    vendorName: 'State v. Marcus Thompson',
    riskTier: 'CRITICAL',
    overallRiskScore: 82,
    hasPiiAccess: true,
    hasPhiAccess: true,
  ...
  {
    vendorName: 'State v. Deshawn Williams',
    riskTier: 'HIGH',
    overallRiskScore: 68,
    hasPiiAccess: true,
    hasPhiAccess: false,
  ...
  {
    vendorName: 'State v. Karen Mitchell',
    riskTier: 'HIGH',
    overallRiskScore: 71,
    hasPiiAccess: true,
    hasPhiAccess: false,
  ...
  {
    vendorName: 'State v. Roberto Alvarez',
    riskTier: 'CRITICAL',
    overallRiskScore: 88,
    hasPiiAccess: true,
    hasPhiAccess: false,
  ...
  {
    vendorName: 'Martinez v. Martinez',
    riskTier: 'MEDIUM',
    overallRiskScore: 45,
    hasPiiAccess: true,
    hasPhiAccess: true,
  ...
  {
    vendorName: 'Chen v. Apex Properties LLC',
    riskTier: 'LOW',
    overallRiskScore: 28,
    hasPiiAccess: true,
    hasPhiAccess: true,
  ...
  {
    vendorName: 'State v. Tyrone Jackson',
    riskTier: 'HIGH',
    overallRiskScore: 58,
    hasPiiAccess: true,
    hasPhiAccess: false,
  ...
  {
    vendorName: 'State v. Angela Foster',
    riskTier: 'HIGH',
    overallRiskScore: 65,
    hasPiiAccess: true,
    hasPhiAccess: false,
  ...
  {
    vendorName: 'State v. Brian Kowalski',
    riskTier: 'MEDIUM',
    overallRiskScore: 35,
    hasPiiAccess: true,
    hasPhiAccess: true,
...
const DOCUMENTS: DocSeed[] = [
  ...
  { vendorName: 'State v. Deshawn Williams', documentType: 'DISCOVERY_MATERIALS', documentName: 'Surveillance Footage Transcript — QuikMart Parking Lot', status: 'RECEIVED', retrievedBy: 'DORA', expiresInDays: 45, analysisResult: null },

  // Karen Mitchell - Embezzlement
  { vendorName: 'State v. Karen Mitchell', documentType: 'EXPERT_REPORT', documentName: 'Forensic Accounting Audit — Northland Credit Union', status: 'ANALYZED', retrievedBy: 'DORA', expiresInDays: null, analysisResult: 'Audit identifies $347,000 in diverted funds over 28 months. Pattern of small wire transfers ($3,000-$12,000) to three shell accounts. Some transactions predate the charging period.' },
  { vendorName: 'State v. Karen Mitchell', documentType: 'FINANCIAL_DISCLOSURE', documentName: 'Bank Records Subpoena Response — Wells Fargo', status: 'ANALYZED', retrievedBy: 'DORA', expiresInDays: null, analysisResult: 'Account statements show deposits inconsistent with reported income. Three accounts linked to Mitchell. Defense: joint account with spouse may explain some deposits.' },
  { vendorName: 'State v. Karen Mitchell', documentType: 'DISCOVERY_MATERIALS', documentName: 'Employment Records — Northland Credit Union HR File', status: 'PENDING', retrievedBy: 'DORA', expiresInDays: 20, analysisResult: null },

  // Roberto Alvarez - Drug Possession
  { vendorName: 'State v. Roberto Alvarez', documentType: 'COURT_FILING', documentName: 'Search Warrant — 1847 Lyndale Ave S', status: 'ANALYZED', retrievedBy: 'DORA', expiresInDays: null, analysisResult: 'Warrant authorized search of residence and vehicles. Scope limited to "narcotics, paraphernalia, and records of drug transactions." Officers also searched detached garage — scope question flagged.' },
  { vendorName: 'State v. Roberto Alvarez', documentType: 'EXPERT_REPORT', documentName: 'BCA Lab Analysis Report — Controlled Substance', status: 'ANALYZED', retrievedBy: 'DORA', expiresInDays: null, analysisResult: 'Analysis confirms methamphetamine, 42.3 grams. Weight meets threshold for presumption of intent to distribute under Minn. Stat. 152.022. Lab tech certification status needs verification.' },
  { vendorName: 'State v. Roberto Alvarez', documentType: 'DISCOVERY_MATERIALS', documentName: 'Chain of Custody Documentation — Evidence Items 1-14', status: 'ANALYZED', retrievedBy: 'DORA', expiresInDays: 60, analysisResult: 'Chain of custody log shows 6-hour gap between evidence collection and booking. Transport officer signature missing on transfer form. Defense motion potential.' },

  // Martinez v. Martinez - Custody
  { vendorName: 'Martinez v. Martinez', documentType: 'CUSTODY_EVALUATION', documentName: 'Custody Evaluation Report — Dr. Angela Reeves', status: 'ANALYZED', retrievedBy: 'DORA', expiresInDays: null, analysisResult: 'Evaluator recommends joint legal custody with primary physical custody to mother. Father granted standard parenting time. Notes concern about incomplete home study for father\'s new residence.' },
  { vendorName: 'Martinez v. Martinez', documentType: 'FINANCIAL_DISCLOSURE', documentName: 'Financial Disclosure — Carlos Martinez', status: 'ANALYZED', retrievedBy: 'DORA', expiresInDays: null, analysisResult: 'Disclosed income of $78,000/year. Discrepancy noted between tax returns and pay stubs for months of July-September. Possible unreported freelance income.' },
  { vendorName: 'Martinez v. Martinez', documentType: 'MOTION', documentName: 'Proposed Parenting Plan — Elena Martinez', status: 'RECEIVED', retrievedBy: 'DORA', expiresInDays: 90, analysisResult: null },

  // Chen v. Apex Properties - Personal Injury
  { vendorName: 'Chen v. Apex Properties LLC', documentType: 'INCIDENT_REPORT', documentName: 'Incident Report — Apex Mall Slip and Fall', status: 'ANALYZED', retrievedBy: 'DORA', expiresInDays: null, analysisResult: 'Report filed 45 minutes after incident. Notes wet floor near entrance with no signage. Maintenance log shows last inspection 4 hours prior. Two witnesses identified.' },
  { vendorName: 'Chen v. Apex Properties LLC', documentType: 'MEDICAL_RECORDS', documentName: 'Medical Records — Hennepin Healthcare ER Visit', status: 'RECEIVED', retrievedBy: 'DORA', expiresInDays: 30, analysisResult: null },
  { vendorName: 'Chen v. Apex Properties LLC', documentType: 'EXPERT_REPORT', documentName: 'Property Inspection Report — SafeWalk Consulting', status: 'ANALYZED', retrievedBy: 'DORA', expiresInDays: null, analysisResult: 'Inspector found drainage deficiency at main entrance. Floor material rated below acceptable slip resistance when wet. Three prior incident reports at same location in past 18 months.' },

  // Banks Estate - Probate
  { vendorName: 'Banks Estate', documentType: 'CONTRACT', documentName: 'Last Will and Testament — Harold J. Banks', status: 'ANALYZED', retrievedBy: 'DORA', expiresInDays: null, analysisResult: 'Will executed 2019-03-15, witnessed by two individuals. Leaves 60% of estate to daughter Margaret Banks, 30% to son David Banks, 10% to Hennepin County Humane Society. Codicil from 2022 modifies distribution.' },
  { vendorName: 'Banks Estate', documentType: 'FINANCIAL_DISCLOSURE', documentName: 'Asset Inventory — Banks Estate', status: 'ANALYZED', retrievedBy: 'DORA', expiresInDays: 180, analysisResult: 'Total estimated estate value: $2.1M. Includes residence ($680K), investment accounts ($890K), life insurance ($350K), personal property ($180K). Potential tax implications require review.' },
  { vendorName: 'Banks Estate', documentType: 'OTHER', documentName: 'Beneficiary Designation Disputes — Insurance & IRA', status: 'PENDING', retrievedBy: 'DORA', expiresInDays: 150, analysisResult: null },

  // Motion documents
  { vendorName: 'State v. Marcus Thompson', documentType: 'MOTION_TO_SUPPRESS', documentName: 'Motion to Suppress — Breathalyzer Results', status: 'PENDING', retrievedBy: 'DORA', expiresInDays: 12, analysisResult: null },
  { vendorName: 'State v. Roberto Alvarez', documentType: 'MOTION_TO_SUPPRESS', documentName: 'Motion to Suppress — Garage Search Evidence', status: 'PENDING', retrievedBy: 'DORA', expiresInDays: 18, analysisResult: null },
  { vendorName: 'State v. Karen Mitchell', documentType: 'MOTION_TO_DISMISS', documentName: 'Motion to Dismiss — Counts 4, 7, 11 (Statute of Limitations)', status: 'RECEIVED', retrievedBy: 'DORA', expiresInDays: 8, analysisResult: null },
  { vendorName: 'State v. Deshawn Williams', documentType: 'MOTION_TO_DISMISS', documentName: 'Motion to Dismiss — Insufficient Evidence', status: 'PENDING', retrievedBy: 'DORA', expiresInDays: 25, analysisResult: null },
  { vendorName: 'Martinez v. Martinez', documentType: 'MOTION_FOR_CONTINUANCE', documentName: 'Motion for Continuance — Custody Hearing', status: 'RECEIVED', retrievedBy: 'DORA', expiresInDays: 15, analysisResult: null },
  { vendorName: 'State v. Roberto Alvarez', documentType: 'MOTION_IN_LIMINE', documentName: 'Motion in Limine — Exclude Prior Bad Acts', status: 'PENDING', retrievedBy: 'DORA', expiresInDays: 30, analysisResult: null },

  // Documents for new vendors
  { vendorName: 'State v. Tyrone Jackson', documentType: 'POLICE_REPORT', documentName: 'Jackson Domestic Assault Police Report — Officer Nguyen', status: 'RECEIVED', retrievedBy: 'DORA', expiresInDays: null, analysisResult: null },
  { vendorName: 'State v. Tyrone Jackson', documentType: 'WITNESS_STATEMENT', documentName: 'Victim Statement — Confidential', status: 'RECEIVED', retrievedBy: 'DORA', expiresInDays: null, analysisResult: null },
  { vendorName: 'Peterson v. MN DOT', documentType: 'DISCOVERY_MATERIALS', documentName: 'Employment Records — MN DOT Human Resources', status: 'PENDING', retrievedBy: 'DORA', expiresInDays: 30, analysisResult: null },
  { vendorName: 'Peterson v. MN DOT', documentType: 'DISCOVERY_MATERIALS', documentName: 'Termination Letter and Disciplinary File — David Peterson', status: 'PENDING', retrievedBy: 'DORA', expiresInDays: 30, analysisResult: null },
  { vendorName: 'State v. Angela Foster', documentType: 'FINANCIAL_DISCLOSURE', documentName: 'Bank Records Subpoena Response — US Bank', status: 'RECEIVED', retrievedBy: 'DORA', expiresInDays: null, analysisResult: null },
  { vendorName: 'State v. Angela Foster', documentType: 'POLICE_REPORT', documentName: 'Identity Theft Report — Minneapolis PD Case #26-4891', status: 'RECEIVED', retrievedBy: 'DORA', expiresInDays: null, analysisResult: null },
]

// ============================================
// Sample case reviews (assessments)
// ============================================
...
const ASSESSMENTS: AssessmentSeed[] = [
  { vendorName: 'State v. Marcus Thompson', assessmentType: 'PRETRIAL', assessmentStatus: 'COMPLETE', riskRating: 'HIGH', overallAssessmentScore: 72, assessedBy: 'CLARA', summary: 'Defense strength is moderate. Breathalyzer calibration issue provides a viable suppression argument. Prior conviction complicates sentencing but does not affect admissibility challenge. Recommend aggressive pretrial motions strategy targeting equipment maintenance records.', daysAgo: 14 },
  { vendorName: 'State v. Deshawn Williams', assessmentType: 'INITIAL', assessmentStatus: 'COMPLETE', riskRating: 'MEDIUM', overallAssessmentScore: 58, assessedBy: 'CLARA', summary: 'Circumstantial case — no direct evidence of vehicle theft by client. Found sleeping in vehicle could support alternative narratives (permission, confusion). Surveillance footage gap weakens prosecution timeline. Witness credibility strong but statement has inconsistencies on timing.', daysAgo: 30 },
  { vendorName: 'State v. Karen Mitchell', assessmentType: 'INITIAL', assessmentStatus: 'IN_PROGRESS', riskRating: null, overallAssessmentScore: null, assessedBy: 'CLARA', summary: 'Assessment in progress. Forensic accounting report under detailed review. Key defense angle: some transactions predate the charged period, and joint account with spouse complicates attribution. Statute of limitations analysis critical for 3 of 12 counts.', daysAgo: 10 },
  { vendorName: 'State v. Roberto Alvarez', assessmentType: 'PRETRIAL', assessmentStatus: 'COMPLETE', riskRating: 'HIGH', overallAssessmentScore: 78, assessedBy: 'CLARA', summary: 'Strong defense potential on constitutional grounds. Search warrant scope likely exceeded when officers searched detached garage. Chain of custody gap and lab tech certification lapse provide additional suppression arguments. If evidence suppressed, case significantly weakened.', daysAgo: 7 },
  { vendorName: 'Martinez v. Martinez', assessmentType: 'INITIAL', assessmentStatus: 'COMPLETE', riskRating: 'MEDIUM', overallAssessmentScore: 50, assessedBy: 'CLARA', summary: 'Custody evaluator\'s recommendation favors our client (mother). Father\'s financial disclosure inconsistencies strengthen child support argument. Incomplete home study for father\'s new residence is a vulnerability for opposing side. Settlement negotiations recommended before trial.', daysAgo: 21 },
  { vendorName: 'Chen v. Apex Properties LLC', assessmentType: 'SETTLEMENT', assessmentStatus: 'COMPLETE', riskRating: 'LOW', overallAssessmentScore: 35, assessedBy: 'CLARA', summary: 'Strong plaintiff case. Property inspection confirms negligence — inadequate drainage, substandard flooring, and three prior incidents at same location establish pattern. Medical records support claimed injuries. Recommend demand letter at $175K with settlement target of $120K-$140K.', daysAgo: 15 },
  { vendorName: 'Banks Estate', assessmentType: 'INITIAL', assessmentStatus: 'PENDING_REVIEW', riskRating: 'MEDIUM', overallAssessmentScore: 42, assessedBy: 'CLARA', summary: 'Estate administration proceeding with minor complications. Codicil from 2022 modifies original will distribution and may be contested by son David Banks. Beneficiary designations on insurance and IRA conflict with will provisions — requires careful analysis of non-probate assets.', daysAgo: 5 },
  { vendorName: 'State v. Marcus Thompson', assessmentType: 'TRIGGERED', assessmentStatus: 'COMPLETE', riskRating: 'HIGH', overallAssessmentScore: 75, assessedBy: 'CLARA', summary: 'Triggered by discovery of additional calibration records. State crime lab provided maintenance logs showing pattern of delayed recalibration across multiple Intoxilyzer units in Hennepin County. May support systemic challenge beyond individual case.', daysAgo: 3 },
]

// ============================================
// Sample legal issues (findings)
// ============================================
...
const FINDINGS: FindingSeed[] = [
  ...
  // Mitchell embezzlement findings
  {
    vendorName: 'State v. Karen Mitchell',
  ...
  // Alvarez drug possession findings
  {
    vendorName: 'State v. Roberto Alvarez',
...
const REPORTS: ReportSeed[] = [
  { vendorName: 'State v. Marcus Thompson', reportType: 'DETAILED_ASSESSMENT', reportName: 'Thompson DUI Defense Strategy Report', status: 'APPROVED', daysAgo: 12 },
  { vendorName: 'State v. Roberto Alvarez', reportType: 'DETAILED_ASSESSMENT', reportName: 'Alvarez Suppression Motion Analysis', status: 'GENERATED', daysAgo: 5 },
  { vendorName: 'Chen v. Apex Properties LLC', reportType: 'DETAILED_ASSESSMENT', reportName: 'Chen v. Apex Settlement Demand Analysis', status: 'APPROVED', daysAgo: 10 },
  { vendorName: 'State v. Karen Mitchell', reportType: 'DETAILED_ASSESSMENT', reportName: 'Mitchell Embezzlement Defense Strategy Report', status: 'GENERATED', daysAgo: 8 },
  { vendorName: null, reportType: 'EXECUTIVE_SUMMARY', reportName: 'Q1 2026 Caseload Executive Summary', status: 'PUBLISHED', daysAgo: 7 },
  { vendorName: null, reportType: 'PORTFOLIO_OVERVIEW', reportName: 'Active Caseload Overview — March 2026', status: 'GENERATED', daysAgo: 3 },
  { vendorName: null, reportType: 'COMPLIANCE_STATUS', reportName: 'Q1 2026 Court Deadlines Compliance Report', status: 'PENDING_APPROVAL', daysAgo: 5 },
]
...
async function main() {
  ...
  const findingDetailMap: Record<string, string> = {}
  for (const f of FINDINGS) {
    ...
    // Key by vendorName:title for remediation action references
    findingDetailMap[`${f.vendorName}:${f.title}`] = finding.id
  }
  console.log(`  ${FINDINGS.length} findings`)

  // 8b. Create remediation actions
  const remediationSeeds = [
    { findingTitle: 'Breathalyzer calibration expired at time of arrest', vendorName: 'State v. Marcus Thompson', title: 'File motion to suppress breathalyzer results', actionType: 'REMEDIATE', priority: 'CRITICAL', status: 'IN_PROGRESS', dueDays: 10, assignedTo: 'Atty. James Vanmerven', ownerType: 'INTERNAL' },
    { findingTitle: 'Search warrant scope potentially exceeded', vendorName: 'State v. Roberto Alvarez', title: 'Draft suppression motion for garage search', actionType: 'REMEDIATE', priority: 'CRITICAL', status: 'OPEN', dueDays: 14, assignedTo: 'Atty. James Vanmerven', ownerType: 'INTERNAL' },
    { findingTitle: 'Medical records release incomplete', vendorName: 'Chen v. Apex Properties LLC', title: 'Send supplemental records request to PT department', actionType: 'REMEDIATE', priority: 'MEDIUM', status: 'IN_PROGRESS', dueDays: 25, assignedTo: 'Paralegal Jason Lee', ownerType: 'INTERNAL' },
    { findingTitle: 'Home study report incomplete for father\'s residence', vendorName: 'Martinez v. Martinez', title: 'Schedule follow-up home study visit', actionType: 'REMEDIATE', priority: 'MEDIUM', status: 'OPEN', dueDays: 28, assignedTo: 'Paralegal Maria Santos', ownerType: 'INTERNAL' },
    { findingTitle: 'Statute of limitations approaching on 3 counts', vendorName: 'State v. Karen Mitchell', title: 'File motion to dismiss time-barred counts', actionType: 'REMEDIATE', priority: 'HIGH', status: 'IN_PROGRESS', dueDays: 7, assignedTo: 'Atty. Laura Vanmerven', ownerType: 'INTERNAL' },
  ]

  for (const r of remediationSeeds) {
    const vendorId = vendorMap[r.vendorName]
    const findingId = findingDetailMap[`${r.vendorName}:${r.findingTitle}`]
    if (!vendorId || !findingId) continue
    ...
    await prisma.remediationAction.create({
      data: {
        ...
        priority: r.priority,
        status: r.status,
        dueDate: new Date(Date.now() + r.dueDays * 24 * 60 * 60 * 1000),
        managedBy: 'ATLAS',
      },
    })
  }
  console.log(`  ${remediationSeeds.length} remediation actions`)
  ...
  const activities = [
    { agentName: 'LEXA', activityType: 'RISK_PROFILING', actionTaken: 'Calculated case profile for State v. Marcus Thompson — CRITICAL priority, DUI 2nd offense with potential suppression issues', status: 'SUCCESS' },
    { agentName: 'CLARA', activityType: 'ASSESSMENT', actionTaken: 'Completed pretrial case review for State v. Thompson — defense strength moderate, breathalyzer challenge viable', status: 'SUCCESS' },
    ...
    { agentName: 'ARIA', activityType: 'DOCUMENT_ANALYSIS', actionTaken: 'Analyzed Thompson police DUI report — identified Miranda timing issue and calibration lapse, 2 critical findings', status: 'SUCCESS' },
    ...
    { agentName: 'CLARA', activityType: 'ASSESSMENT', actionTaken: 'Started initial case review for State v. Karen Mitchell — embezzlement defense, statute of limitations critical', status: 'SUCCESS' },
    ...
    { agentName: 'ATLAS', activityType: 'REMEDIATION_PLAN', actionTaken: 'Created action plan for Thompson suppression motion — breathalyzer expert engagement, motion drafting, hearing prep', status: 'SUCCESS' },
  ]
...
3. Map findings to VLF's Legal Issue Framework
4. Assess the impact of each finding on case strategy and outcomes
...
6. Cross-reference findings across multiple documents for consistency

Provide specific, actionable findings with clear strategic recommendations for the defense or litigation team.`,
    },
    {
      slug: 'rita-system',
...
2. DETAILED_ASSESSMENT (Case Summary): In-depth case analysis for attorneys
   - Complete findings inventory with severity ratings
...
- "different": Different documents entirely (different type, scope, or subject matter).`,
  ...
  const notificationSeeds = [
    {
      ...
      relatedEntityId: findingMap['State v. Marcus Thompson'] || null,
      sentBy: 'ATLAS',
      status: 'PENDING',
      daysAgo: 1,
    },
    {
      ...
      relatedEntityType: 'RiskFinding',
      relatedEntityId: findingMap['State v. Karen Mitchell'] || null,
      sentBy: 'ATLAS',
      status: 'PENDING',
      daysAgo: 2,
    },
    {
      ...
      relatedEntityType: 'RiskFinding',
      relatedEntityId: findingMap['State v. Roberto Alvarez'] || null,
      sentBy: 'ATLAS',
      status: 'PENDING',
      daysAgo: 3,
    },
    {
      ...
      relatedEntityId: vendorMap['State v. Karen Mitchell'] || null,
      sentBy: 'DORA',
      status: 'PENDING',
      daysAgo: 5,
    },
    {
      ...
      relatedEntityType: 'RiskFinding',
      relatedEntityId: findingMap['Martinez v. Martinez'] || null,
      sentBy: 'ATLAS',
      status: 'READ',
      daysAgo: 10,
    },
  ...
  for (const c of CONTACTS) {
    ...
    for (const link of c.caseLinks) {
      const vendorId = vendorMap[link.caseName]
      if (vendorId) {
        await prisma.caseContact.create({
          data: { vendorId, contactId: contact.id, role: link.role },
        })
      }
    }
  }
